...
namespace appOlissShop.Repositorio.DBContext;
...
public partial class DbEcommerceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__A3C02A1051EB3E5F");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__AAA5CEC264E0AF92");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__09889210D130270B");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97291ED268");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__BC1240BD1535D787");
